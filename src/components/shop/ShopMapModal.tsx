      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl bg-app-modal border border-app-border rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl z-[10000] flex flex-col max-h-[90vh] text-app-primary"
            ...
            <div className="px-5 py-4 bg-app-modal-header border-b border-app-border flex items-center justify-between gap-3 shrink-0">
              <div className="flex items-center gap-2.5 min-w-0">
                ...
                <div className="min-w-0">
                  <h3 className="text-sm sm:text-base font-semibold text-app-primary truncate">
                    {shop.name}
                  </h3>
